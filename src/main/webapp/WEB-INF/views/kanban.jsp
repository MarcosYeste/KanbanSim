...
-->
    ...
    <div class="botonesContainer1" id="botonesContainer1">
        ...
        <div class="doubleButton" id="doubleButton">
            <button id="divDelete">
                <i id="deleteAll" class="fas fa-file fa-3x" data-toggle="tooltip" data-placement="top" title="Nuevo Tablero"></i>
            </button>

            <!-- Botón para mostrar información del tablero -->
            <button id="info" data-target="#generalInfo" data-toggle="modal">
                <i id="infoIcon" class="fas fa-info-circle fa-3x" data-toggle="tooltip" data-placement="top" title="Info"></i>
            </button>
...
-->
    ...
    <fieldset class="teamField">
        ...
        <legend class="teamField">
            Miembros del Equipo:<span style="float: left; margin-left: 80%;" class="legUser">
                <!-- margin-left :80% -->
                <button id="addUser">
                    <i class="fas fa-user-plus fa-2x" data-toggle="modal" data-target="#addUsers"></i>
                </button>
            </span>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Nombre Fase: <input type="text" id="addName" placeholder="Nombre Fase" required> WIP: <input type="text" id="addWip" value="1" required> Tiempo Mínimo:
                    <input type="text" id="addMinTime" value="1" required>
                    Tiempo Máximo: <input type="text" id="addMaxTime" value="1" required> Color:
                    <div class="col-10">
                        <input class="form-control" type="color" id="color-input" list="presetColors" value="#4ce600">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="number" id="modWip"> Tiempo Mínimo: <input type="number" id="modMinTime"> Tiempo Máximo: <input type="number" id="modMaxTime"> Color:
                    <div class="col-10">
                        <input class="form-control" type="color" id="color-input2" list="presetColors2">
            ...
            <div class="modal-content">
             ...
             <!--        <button type="button" class="close" data-dismiss="modal">&times;</button> -->
                ...
                <div class="modal-body">
                    ...
                    <br>
                    <button id="modUsuario" class="btn btn-secondary" data-dismiss="modal">Modificar</button>
    ...
    <div class="modal fade" id="addUsers" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Nombre Usuario: <input type="text" id="addNameUser" placeholder="Nombre">
                    <div>Fases:</div>
                    <div id="addFasesUser"></div>
                    <br> Rendimiento por fase:
                    <div id="addSkillsUser"></div>
                    <br>
                    <button id="addUsuario" class="btn btn-secondary" data-dismiss="modal">Añadir</button>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <button id="modChrono" class="btn btn-secondary" data-dismiss="modal">Modificar</button>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <input type="radio" name="taskInputMode" class="distributionRadio" value="manual" checked /> Manual <input type="radio" name="taskInputMode" class="distributionRadio" value="constant" /> Constante
                        </div>

                        <p>Distribución</p>
                        <div>
                            <input type="radio" name="distributionType" class="distributionRadio" value="normal" disabled>
                            Normal <input type="radio" name="distributionType" class="distributionRadio" value="poisson" disabled>
                            Poisson <input type="radio" name="distributionType" class="distributionRadio" value="weight" disabled> Con
                            peso
                        </div>
                        ...
                        <div id="distributionData">
                            ...
                            <div id="dataNormalDistribution" style="visibility: collapse; height: 0px">
                                ...
                                <input type="number" class="backloglabelInput" id="normalBaseValue" name="base" value="1" min="1"><br>
                                <p class="backloglabel">Varianza:</p>
                                <input type="number" class="backloglabelInput" id="normalVarianceValue" name="variznce" value="1" min="1">
                            </div>

                            <div id="dataPoissonDistribution" style="visibility: collapse; height: 0px">
                                <p class="backloglabel">Base:</p>
                                <input type="number" class="backloglabelInput" id="poissonLambda" name="lambda" value="1" min="1">
                            </div>
    ...
    <div class="modal fade" id="modalBlueprint" role="dialog">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Nombre Plantilla: <input type="text" id="inputBlueprintName" placeholder="Nombre Plantilla"> <br>
                    <button id="addBlueprint" class="btn btn-secondary" data-dismiss="modal">Añadir</button>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <button id="selectBlueprint" class="btn btn-secondary" data-dismiss="modal">Selecionar</button>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                </div>
