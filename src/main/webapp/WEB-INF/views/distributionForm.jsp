			...
			<div class="card-body">
				...
				<div id="distributionData">				
					...
					<div id="dataWeightDistribution" style="visibility: collapse; height: 0px">
						<p class="backloglabel">S:</p>  <div class="backloglabelInput size" id="S" ><div id="custom-handle0"  class="ui-slider-handle"></div><div class="sizeValue">0</div></div>
						<p class="backloglabel">M:</p>  <div class="backloglabelInput size" id="M" ><div id="custom-handle1"  class="ui-slider-handle"></div><div class="sizeValue">0</div></div>
						<p class="backloglabel">L:</p>  <div class="backloglabelInput size" id="L" ><div id="custom-handle2"  class="ui-slider-handle"></div><div class="sizeValue">0</div></div>
						<p class="backloglabel">XL:</p> <div class="backloglabelInput size" id="XL"><div id="custom-handle3" class="ui-slider-handle"></div><div class="sizeValue">0</div></div>
					</div>
