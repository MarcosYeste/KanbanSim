...
function tableUser() {
    ...
    if (listResultados[0].userNamesWorstBest[0] == undefined) {
        listResultados[0].userNamesWorstBest[0] = [" "]
    }
    ...
    if (listResultados[0].userNamesWorstBest[1] == undefined) {
        listResultados[0].userNamesWorstBest[1] = [" "]
    }
...
function calcularMediaPorTarea(mediaPorTarea, timeByStats) {
    ...
    for (var i = 0; i < timeByStats.length; i++) {
        if (timeByStats[i] == undefined) {
            ...
            if (timeByStats[i][1] == undefined) {
                timeByStats[i][1] = 0;
            }
            if (timeByStats[i][2] == undefined) {
                timeByStats[i][2] = 0;
            }
        }
        ...
        while (z < array[0].length) {
            ...
            for (var i = 0; i < array.length; i++) {
                if (array[i][z] != undefined) {
                    ...
                    if (array[i][z][1] == undefined) {
                        array[i][z][1] = 0;
                    }
                    if (array[i][z][2] == undefined) {
                        array[i][z][2] = 0;
                    }
